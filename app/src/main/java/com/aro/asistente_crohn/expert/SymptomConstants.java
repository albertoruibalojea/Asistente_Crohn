...
public class SymptomConstants {
    ...
    //Patterns
    public static final String PATTERN_GENERIC = "PATTERN_GENERIC";
    public static final String PATTERN_SMALL_BOWEL = "PATTERN_SMALL_BOWEL";
    public static final String PATTERN_COLON = "PATTERN_COLON";
    ...
    public static final Integer VALUE_PATTERN_GENERIC = VALUE_DIAREE + VALUE_ABDOMINAL_PAIN + VALUE_TIRED + VALUE_LESS_WEIGHT + VALUE_BLOOD + VALUE_NOT_HUNGRY + VALUE_ARTICULAR_PAIN + VALUE_HEADACHE + VALUE_SKIN_ISSUE;
    public static final Integer VALUE_PATTERN_SMALL_BOWEL = VALUE_DIAREE + VALUE_ABDOMINAL_PAIN + VALUE_TIRED + VALUE_FEVER + VALUE_LESS_WEIGHT + VALUE_APHTHAS + VALUE_SKIN_ISSUE;
    public static final Integer VALUE_PATTERN_COLON = VALUE_DIAREE + VALUE_ABDOMINAL_PAIN + VALUE_FEVER + VALUE_BLOOD + VALUE_BATHROOM_URGE + VALUE_APHTHAS + VALUE_SKIN_ISSUE;
